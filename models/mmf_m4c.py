...
from modules.ocr_encoder import OCREncoder
...
class MMF_M4C(nn.Module):
    ...
    def __init__(self, config, vocab):
        ...
        self.constituent_block = OCREncoder(config.VICONSFORMER, word_embed=None)
    ...
    def _forward_ocr_encoding(self, items, fwd_results):
        ...
        # mask: (B, 1, 1, seq_len)
        # ocr_mmt_in: (B, S, hidden_size(768))
        ocr_mmt_in = self.constituent_block(ocr_mmt_in, mask)
